    ...
    <CardContent className="p-5 flex flex-col justify-around h-full">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <span className="text-[9px] font-bold text-muted-foreground uppercase opacity-70">Yesterday</span>
        ...
        <div className="flex items-center justify-between">
          <span className="text-[9px] font-bold text-muted-foreground uppercase opacity-70">Weekly High</span>
          <div className="flex items-center gap-2">
        ...
        <div className="flex items-center justify-between">
          <span className="text-[9px] font-bold text-muted-foreground uppercase opacity-70">Monthly High</span>
          <div className="flex items-center gap-2">
