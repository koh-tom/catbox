    ...
    <>
      <CardContent className="p-6 sm:p-8 flex flex-col justify-between h-full relative z-10">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight leading-tight">{greeting}</h1>
          <p className="text-xs sm:text-sm text-muted-foreground mt-2 font-medium">現在、{activeCount}件の未完了タスクがあります。</p>
        </div>
      </CardContent>
